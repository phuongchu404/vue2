export default {
  ...
  "user.resetPasswordConfirm": "After reset password, please notify user。Are you sure to reset password？",
  "user.resetPasswordSuccess": "Reset password successfully。New password is：[",
