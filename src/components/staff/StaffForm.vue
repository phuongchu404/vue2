...
const rules: FormRules = {
  staffCode: [
    {
      required: true,
      message: t("staff.validation.required.code"),
      trigger: "blur",
    },
    {
      min: 3,
  ...
  fullName: [
    ...
    },
    {
      min: 2,
      max: 50,
      message: t("staff.validation.length.fullName"),
      trigger: "blur",
    },
  ],
  gender: [
    {
      required: true,
      message: t("staff.validation.required.gender"),
      trigger: "change",
    },
  ],
  phone: [
    {
      required: true,
      message: t("staff.validation.required.phone"),
      trigger: "blur",
    },
    {
      pattern: /^[0-9]{10,11}$/,
  ...
  email: [
    {
      type: "email",
      message: t("staff.validation.pattern.email"),
      trigger: "blur",
    },
  ],
  rank: [
    {
      required: true,
      message: t("staff.validation.required.rank"),
      trigger: "blur",
    },
  ],
  detentionCenterId: [
    {
      required: true,
      message: t("staff.validation.required.detentionCenter"),
      trigger: "change",
    },
  ],
  status: [
    {
      required: true,
      message: t("staff.validation.required.status"),
      trigger: "change",
    },
  ],
};
