export default {
    ...
    "form": {
        ...
        "guideDescription": "Collect all: 10 individual fingerprints, 4-finger slaps (both hands), full hands (both). Formats: JPG, PNG, WSQ. Max: 5MB.",
    },
    "section": {
    ...
    "collect": {
        ...
        "leftHand": "Left Hand",
        "fourFingers": {
            "title": "Four-Finger Slap",
            "desc": "Collect four-finger slap images for each hand"
        },
        "fullHands": {
    ...
    "preview": {
        ...
        "fourSlaps": "Four-finger slaps ({{count}}/2)",
    ...
    "detail": {
        ...
        "section": {
            "collected": "Collected fingerprints",
            "individual": "Individual fingerprints",
            "fourFingers": "Four fingers together",
    ...
    "compare": {
        ...
        "alertDesc": "This function compares fingerprints in the database to find possible matches.",
