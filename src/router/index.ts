  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: "prisonAdd", activeMenu: '/prisons' },
      },
      {
        path: "/prisons/edit/:id",
        name: "PrisonEdit",
        component: PrisonForm,
        meta: { title: "prisonEdit", activeMenu: '/prisons' },
      },
      {
        path: "/detainees",
        name: "DetaineeList",
      ...
      },
      {
        ...
        meta: { title: "detaineeAdd", activeMenu: '/detainees' },
      },
      {
        path: "/detainees/edit/:id",
        name: "DetaineeEdit",
        component: DetaineeForm,
        meta: { title: "detaineeEdit", activeMenu: '/detainees' },
      },
      {
        path: "/staff",
        name: "StaffList",
      ...
      },
      {
        ...
        name: "StaffAdd",
        component: StaffForm,
        meta: { title: "staffAdd", activeMenu: '/staff' },
      },
      {
        path: "/staff/edit/:id",
        name: "StaffEdit",
        component: StaffForm,
        meta: { title: "staffEdit", activeMenu: '/staff' },
      },
      {
        path: "/identity",
        name: "IdentityList",
      ...
      },
      {
        ...
        meta: { title: "identityAdd", activeMenu: '/identity' },
      },
      {
        path: "/identity/edit/:id",
        name: "IdentityEdit",
        component: IdentityForm,
        meta: { title: "identityEdit", activeMenu: '/identity' },
      },
      {
        path: "/fingerprint",
        name: "Fingerprint",
      ...
      },
      {
        ...
        meta: { title: "fingerprintAdd", activeMenu: '/fingerprint' },
      },
      {
        path: "/fingerprint/edit/:id",
        name: "fingerprintEdit",
        component: FingerprintForm,
        meta: { title: "fingerprintEdit", activeMenu: '/fingerprint' },
      },
      {
        path: "/report",
        name: "Reports",
      ...
      },
      {
        ...
        meta: { title: "departmentAdd", activeMenu: '/department' },
      },
      {
        path: "/department/edit/:id",
        name: "departmentEdit",
        component: DepartmentForm,
        meta: { title: "departmentEdit", activeMenu: '/department' },
      },
    ],
  },
];
