      ...
      actions: {
        async fetchList(query: PageQuery) {
          ...
          try {
            ...
            const res: ServiceResult<PagingResult<Department>> = await DepartmentService.list(
                params
            );
            ...
            const msg =
                e?.response?.data?.message || e?.message || "Fetch departments failed";
            this.error = msg;
            ElMessage.error(msg);
          } finally {
            this.loading = false;
        ...
        async fetchDetail(id: number) {
          ...
          this.error = undefined;
          try {
            const res: ServiceResult<Department> = await DepartmentService.getById(id);
        ...
        async createDepartment(payload: CreateDepartmentRequest) {
          ...
          this.error = undefined;
          try {
            const res: ServiceResult<PagingResult<Department>> = await DepartmentService.create(
                payload
            );
            if (!res.success) {
            ...
            const msg =
                e?.response?.data?.message || e?.message || "Create departments failed";
            this.error = msg;
            ElMessage.error(msg);
            throw e;
          } finally {
        ...
        async updateDepartment(id: number, payload: UpdateDepartmentRequest) {
          ...
          try {
            ...
            const msg =
                e?.response?.data?.message || e?.message || "Update departments failed";
            this.error = msg;
            ElMessage.error(msg);
            throw e;
          } finally {
        ...
        async deleteDepartment(id: number) {
          ...
          try {
            ...
            const msg =
                e?.response?.data?.message || e?.message || "Delete departments failed";
            this.error = msg;
            ElMessage.error(msg);
            throw e;
          } finally {
